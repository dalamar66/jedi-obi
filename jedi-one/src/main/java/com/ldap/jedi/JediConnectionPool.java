...
class JediConnectionPool implements JediConnectionManager {
	...
	synchronized public JediConnection getJediConnection(String alias) throws JediConnectionException {
		ArrayList<JediConnectionImpl> jediConnectionList = getConnectionAlias(alias);
		...
		try {
			...
			JediLog.log(JediLog.LOG_PRODUCTION, JediLog.ERROR, "jedi_msg_connection_error", "JediConnectionPool : getJediConnection(String alias)", this);
	...
	public void addConnectionProvider(String alias, Hashtable<String, String> parameters) throws JediException {
		if (alias == null || alias.length() < 1) {
			...
			JediLog.log(JediLog.LOG_PRODUCTION, JediLog.ERROR, "jedi_msg_connection_error", "JediConnectionPool : addConnectionProvider(String alias, Hashtable parameters)", this);
	...
	public String getLdapHost(String alias) throws JediException {
		try {
			...
			JediLog.log(JediLog.LOG_TECHNICAL, JediLog.ERROR, "jedi_msg_connection_error", "", this);
			JediLog.log(JediLog.LOG_PRODUCTION, JediLog.ERROR, "jedi_msg_connection_error", "JediConnectionPool : getLdapHost(String alias)", this);
	...
	public String getRootPath(String alias) throws JediException {
		try {
			...
			JediLog.log(JediLog.LOG_TECHNICAL, JediLog.ERROR, "jedi_msg_connection_error", "", this);
			JediLog.log(JediLog.LOG_PRODUCTION, JediLog.ERROR, "jedi_msg_connection_error", "JediConnectionPool : getRootPath(String alias)", this);
	...
	protected InitialLdapContext getInitialLdapContext(String alias) throws JediConnectionException {
		try {
			...
			JediLog.log(JediLog.LOG_TECHNICAL, JediLog.ERROR, "jedi_msg_connection_error", "", this);
			JediLog.log(JediLog.LOG_PRODUCTION, JediLog.ERROR, "jedi_msg_connection_error", "JediConnectionPool : reconnect(JediConnectionImpl jediconnectionimpl)", this);
	...
	protected JediConnectionImpl createJediConnection(String alias) throws JediConnectionException, JediException {
		try {
			...
			JediLog.log(JediLog.LOG_TECHNICAL, JediLog.ERROR, "jedi_msg_connection_error", "", this);
			JediLog.log(JediLog.LOG_PRODUCTION, JediLog.ERROR, "jedi_msg_connection_error", "JediConnectionPool : createJediConnection(String alias)", this);
	...
	protected ArrayList<JediConnectionImpl> getConnectionAlias(String alias) throws JediConnectionException {
		...
		if (connectionAlias == null) {
			JediLog.log(JediLog.LOG_PRODUCTION, JediLog.ERROR, "jedi_msg_connection_error", "JediConnectionPool : getJediConnectionList(String alias)", this);
	...
	protected Hashtable<String, String> getConnectionParameters(String alias) throws JediException {
		...
		if (connectionParameters == null) {
			JediLog.log(JediLog.LOG_PRODUCTION, JediLog.ERROR, "jedi_msg_connection_error", "JediConnectionPool : getConnectionParameters(String alias)", this);
